package com.hoperun.shuma.open.util;

import com.hoperun.shuma.open.bean.vo.ThreadCipher;
...
public class WeChatUtil {
    ...
    public  byte[] decrypt(byte[] encryptedData, byte[] keyBytes, AlgorithmParameters iv)
        ...
        Cipher ciphers = Cipher.getInstance("AES/CBC/PKCS7Padding","BC");
